...
return [
    'host' => env('AIYO_HOST', 'https://api-bills-invoice.aiyo.id'),
    'username' => env('AIYO_USERNAME', 'FRESH_HYDRATION_KIOS'),
    'password' => env('AIYO_PASSWORD', 'pass_7A9uubvhF0XQZ7gePewlItKt3Uzg2I'),
